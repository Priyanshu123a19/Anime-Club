...
const events = [
  {
    ...
    image: 'https://i.pinimg.com/736x/62/89/4e/62894e8711921c8e4a2c5adb2f9ea154.jpg',
  },
  {
    title: 'Anime Screenings',
    date: '2025-07-18',
    description: 'Weekly anime screenings every Friday. Join us for discussions and fun activities after each screening.',
    image: 'https://i.pinimg.com/736x/e1/97/1f/e1971fe6cf76a0e24dc0ac66444f86b4.jpg',
  }
];
...
const NexusPage = () => (
  <div className="min-h-screen bg-gradient-to-br from-pink-100 via-blue-100 to-purple-200 relative overflow-hidden py-16 px-2">
    ...
    <div className="relative z-10 max-w-4xl mx-auto">
      ...
      >
        NEXUS<br />
        <span className="block text-2xl md:text-3xl font-normal text-blue-400 tracking-widest mt-2">UPCOMING EVENTS</span>
      </motion.h1>
